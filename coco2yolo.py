...
parser.add_argument('--json_path', default='./dataset/annotations/val.json', type=str, help="input: coco format(json)")
parser.add_argument('--save_path', default='./dataset/val', type=str, help="specify where to save the output dir of labels")
